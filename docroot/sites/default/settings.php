 ...
 * @endcode
 */
$settings['hash_salt'] = 'N4CQZim0LU7GgWuyqyq7ZA96Mrh2Cdef7Z1opmwqkEr55O4YigPbZuD';
...
if ($is_local_env) {
  ...
  if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_blted8_dd.inc')) {
    require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_blted8_dd.inc';
  }
